...
const services: Service[] = [
  {
    ...
    description:
      "Available via live chat and emails. Our dedicated team is always ready to assist you whenever you need help.",
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description:
      "Fast processing and dispatch on the same day, depending on stock availability. Get your orders shipped quickly.",
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description:
      "Our collaborative approach ensures seamless service delivery. We work together to meet your healthcare needs efficiently.",
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description:
      "Simple, intuitive, and secure online platform. Browse, select, and order your medical supplies with ease and confidence.",
  },
];
